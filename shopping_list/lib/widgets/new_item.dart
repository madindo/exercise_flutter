...
class _NewItemState extends State<NewItem> {
  ...
  void _saveItem() async {
    if (_formKey.currentState!.validate()) {
      ...
      final url = Uri.https('flutter-udemy-max-7acaa-default-rtdb.asia-southeast1.firebasedatabase.app', 'shopping-list.json');
          ...
          child: Column(
            children: [
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty || value.trim().length
                  <= 1 || value.trim().length > 50) {
